...
import es.lab.shop.config.audit.AuditEventConverter;
import es.lab.shop.domain.PersistentAuditEvent;
...
import static es.lab.shop.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
