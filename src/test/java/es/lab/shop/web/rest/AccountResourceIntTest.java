...
import es.lab.shop.config.Constants;
import es.lab.shop.domain.Authority;
import es.lab.shop.domain.User;
import es.lab.shop.repository.AuthorityRepository;
import es.lab.shop.repository.UserRepository;
import es.lab.shop.security.AuthoritiesConstants;
import es.lab.shop.service.MailService;
import es.lab.shop.service.UserService;
import es.lab.shop.service.dto.PasswordChangeDTO;
import es.lab.shop.service.dto.UserDTO;
import es.lab.shop.web.rest.errors.ExceptionTranslator;
import es.lab.shop.web.rest.vm.KeyAndPasswordVM;
import es.lab.shop.web.rest.vm.ManagedUserVM;
